...
class TOM():
    ...
    def __init__(self, env, args):
        ...
        self.inference_net = Policy(input_size=self.args.state_size, output_size=self.action_size, layers=args.layers).to(self.args.device) # add which player it is 
    ...
    def on_step(self):
        ...
        if self.training_step % 1000 == 0:
            #print(dones_pred, next_masks_pred)
            print(losses)
