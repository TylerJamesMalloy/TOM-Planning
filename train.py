...
parser.add_argument('--planning_pretraining', default=1000, type=int,  help='Number of episodes to pretrain for planning')
...
parser.add_argument('--num_players', default=8, type=int,  help='Number of players')
parser.add_argument('--environment', default="no_limit_holdem", type=str,  help='Number of players')

parser.add_argument('--belief_in', default=118, type=tuple,  help='Environment specific belief input')
parser.add_argument('--belief_out', default=52, type=tuple,  help='Environment specific belief shape')
parser.add_argument('--state_size', default=418, type=tuple,  help='Environment specific state shape after concatonating with belief predictions')
...
#  python .\train.py --save_folder ./trained_models/no_limit_holdem/8_players/TOM/100K/  --model_type TOM 
#  python .\train.py --save_folder ./trained_models/no_limit_holdem/8_players/TOMP/100K/  --model_type TOM --planning 
